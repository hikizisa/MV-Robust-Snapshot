...
{
    public class CustomTimingTranslator : DiffTranslator
    {
        ...
        )
        {
            ...
            double globalShiftHint = CustomHitObjectsTranslator.GetCachedShiftSections(beatmap, oldCode, newCode).globalShiftHint;
